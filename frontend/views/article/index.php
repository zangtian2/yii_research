<?php \frontend\assets\BlogAsset::register($this);?>
        ...
        <div class="col-lg-9">
            <div class="blog-single-content bordered blog-container">
                <div class="blog-single-head">
                    <h1 class="blog-single-head-title" style="overflow: hidden;max-width: 610px;white-space: nowrap;">
                        博客或内容的标题啊博客或内容的标题啊博客或内容的标题啊博客或内容的标题啊博客或内容的标题啊
                    </h1>
                    <div class="blog-single-head-date">
                        <i class="icon-calendar font-blue"></i>
                        <a href="javascript:;">2016-12-25 13:35</a>
                    </div>
                </div>
                <div class="blog-single-img">
                    <img src="/static/images/01.jpg" /> </div>
                ...
                <div class="blog-comments">
                    ...
                    <div class="c-comment-list">
                        <div class="media">
                            <div class="media-left">
                                <a href="#">
                                    <img class="media-object" alt="" src="/static/images/01.jpg"> </a>
                            </div>
                            <div class="media-body">
                                <h4 class="media-heading">
                                    <a href="#">用户1</a> on
                                    <span class="c-date">2016-12-25 15:45</span>
                                </h4> 若你需要重写构造方法（Constructor），传入 $config 作为构造器方法最后一个参数， 然后把它传递给父类的构造方法。 </div>
                        </div>
                        <div class="media">
                            <div class="media-left">
                                <a href="#">
                    ...
                    <h3 class="sbold blog-comments-title"> 发表评论 </h3>
                    <form action="#">
                        <div class="form-group">
                            <input type="text" placeholder="姓名" class="form-control c-square"> </div>
                        <div class="form-group">
                            <input type="text" placeholder="邮箱" class="form-control c-square"> </div>
                        <div class="form-group">
                            <input type="text" placeholder="网站" class="form-control c-square"> </div>
                        <div class="form-group">
                            <textarea rows="8" name="message" placeholder="评论内容 ..." class="form-control c-square"></textarea>
                        </div>
                        <div class="form-group">
            ...
            <div class="blog-single-sidebar bordered blog-container">
                <div class="blog-single-sidebar-search">
                    <div class="input-icon right">
                        ...
                        <input type="text" class="form-control" placeholder="搜索内容"> </div>
                </div>
                <div class="blog-single-sidebar-recent">
                    <h3 class="blog-sidebar-title uppercase">最近的帖子</h3>
                    <ul>
                        <li><a href="javascript:;">Metronic Admin Progress</a></li>
                        <li><a href="javascript:;">New UI Features</a></li>
                        <li><a href="javascript:;">Lorem Ipsum Dolore Amet</a></li>
                        <li><a href="javascript:;">Userfull Pages Released</a></li>
                    </ul>
                </div>
                <div class="blog-single-sidebar-tags">
                    <h3 class="blog-sidebar-title uppercase">标签</h3>
                    <ul class="blog-post-tags">
                        <li class="uppercase"><a href="javascript:;">Bootstrap</a></li>
                        <li class="uppercase"><a href="javascript:;">Sass</a></li>
                        <li class="uppercase"><a href="javascript:;">HTML</a></li>
                        <li class="uppercase"><a href="javascript:;">CSS</a></li>
                        <li class="uppercase"><a href="javascript:;">Gulp</a></li>
                        <li class="uppercase"><a href="javascript:;">Framework</a></li>
                        <li class="uppercase"><a href="javascript:;">Admin Theme</a></li>
                        <li class="uppercase"><a href="javascript:;">UI Features</a></li>
                    </ul>
                </div>
                <div class="blog-single-sidebar-links">
                    <h3 class="blog-sidebar-title uppercase">友情链接</h3>
                    <ul>
                        <li><a href="javascript:;">Lorem Ipsum </a></li>
                        <li><a href="javascript:;">Dolore Amet</a></li>
                        <li><a href="javascript:;">Metronic Database</a></li>
                        <li><a href="javascript:;">UI Features</a></li>
                        <li><a href="javascript:;">Advanced Forms</a></li>
                    </ul>
                </div>
